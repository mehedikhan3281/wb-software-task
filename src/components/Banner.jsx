    ...
    return (
        <div className="mx-2 my-4 md:mt-4 flex md:gap-2 flex-col md:flex-row">
            ...
            <div className='bg-white rounded-sm mb-2'>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/ISwnqW5d9mA?si=rAt2HV2fOz9V6zXG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" ></iframe>
            </div>
        </div>
    );
};
